...
from vocal_forge.core.common import SPEECH_DIR
from vocal_forge.core.generate.common import convert
from vocal_forge.core.generate.speech import (
...
from vocal_forge.web.typing_extra import ConcurrencyId, SpeechSourceType
        ...
        with gr.Accordion("Step 3: speech mixing", open=False):
            ...
            with gr.Row():
                output_name = gr.Textbox(
                    ...
                    placeholder="Vocal Forge speech",
                )
