"""
Web application for the Vocal Forge project.
...
from vocal_forge.common import AUDIO_DIR, MODELS_DIR, TEMP_DIR
from vocal_forge.core.generate.song_cover import get_named_song_dirs
from vocal_forge.core.generate.speech import get_edge_tts_voice_names
from vocal_forge.core.manage.audio import (
    get_audio_datasets,
    get_named_audio_datasets,
    get_saved_output_audio,
    get_saved_speech_audio,
)
from vocal_forge.core.manage.models import (
    get_custom_embedder_model_names,
    get_custom_pretrained_model_names,
    get_training_model_names,
    get_voice_model_names,
)
from vocal_forge.web.tabs.generate.song_cover.multi_step_generation import (
    render as render_song_cover_multi_step_tab,
)
from vocal_forge.web.tabs.generate.song_cover.one_click_generation import (
    render as render_song_cover_one_click_tab,
)
from vocal_forge.web.tabs.generate.speech.multi_step_generation import (
    render as render_speech_multi_step_tab,
)
from vocal_forge.web.tabs.generate.speech.one_click_generation import (
    render as render_speech_one_click_tab,
)
from vocal_forge.web.tabs.manage.audio import render as render_manage_audio_tab
from vocal_forge.web.tabs.manage.models import render as render_manage_models_tab
from vocal_forge.web.tabs.manage.settings import render as render_settings_tab
from vocal_forge.web.tabs.train.multi_step_generation import (
...
def _init_app() -> list[gr.Dropdown]:
    """
    Initialize the Vocal Forge web application by updating the choices
...
def render_app() -> gr.Blocks:
    """
    Render the Vocal Forge web application.
...
def start_app(
    ...
    """Run the Vocal Forge web application."""
