...
# Zluda hijack
import vocal_forge.rvc.lib.zluda
from vocal_forge.common import TRAINING_MODELS_DIR
from vocal_forge.rvc.common import RVC_TRAINING_MODELS_DIR
from vocal_forge.rvc.lib.algorithm import commons
from vocal_forge.rvc.train.losses import (
    discriminator_loss,
    feature_loss,
    generator_loss,
    kl_loss,
)
from vocal_forge.rvc.train.mel_processing import (
    MultiScaleMelSpectrogramLoss,
    mel_spectrogram_torch,
    spec_to_mel_torch,
)
from vocal_forge.rvc.train.process.extract_model import extract_model
from vocal_forge.rvc.train.utils import (
    HParams,
...
def run(
    ...
    from vocal_forge.rvc.train.data_utils import (
    ...
    from vocal_forge.rvc.lib.algorithm.discriminators import MultiPeriodDiscriminator
    from vocal_forge.rvc.lib.algorithm.synthesizers import Synthesizer
