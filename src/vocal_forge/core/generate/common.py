"""
Common definitions for modules in the Vocal Forge project that
generate audio.
"""
...
from vocal_forge.core.generate.typing_extra import (
    AudioExtInternal,
    FileMetaData,
    MixedAudioMetaData,
    MixedAudioType,
...
if TYPE_CHECKING:
    ...
    from vocal_forge.rvc.infer.infer import VoiceConverter
    from vocal_forge.typing_extra import Json, StrPath
else:
...
def _get_voice_converter() -> VoiceConverter:
    ...
    """
    from vocal_forge.rvc.infer.infer import VoiceConverter  # noqa: PLC0415
