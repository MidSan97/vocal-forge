"""
Module which defines functions for initializing the core of the Vocal
Forge project.
"""
...
from vocal_forge.common import VOICE_MODELS_DIR
from vocal_forge.core.common import FLAG_FILE
from vocal_forge.core.generate.song_cover import initialize_audio_separator
from vocal_forge.core.manage.models import download_voice_model
from vocal_forge.rvc.lib.tools.prerequisites_download import (
...
def initialize() -> None:
    """Initialize the Vocal Forge project."""
