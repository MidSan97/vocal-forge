...
from vocal_forge.typing_extra import AudioExt, AudioSplitMethod, TrainingSampleRate
...
if TYPE_CHECKING:
    ...
    from vocal_forge.typing_extra import StrPath
else:
...
def preprocess_dataset(
    ...
    from vocal_forge.rvc.train.preprocess import (  # noqa: PLC0415
