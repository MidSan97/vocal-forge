...
from vocal_forge.core.common import (
    TRAINING_MODELS_DIR,
    VOICE_MODELS_DIR,
...
from vocal_forge.core.exceptions import (
    Entity,
...
from vocal_forge.core.train.common import validate_devices
from vocal_forge.core.train.typing_extra import ModelInfo, TrainingInfo
...
def _get_pretrained_model(
    ...
    match pretrained_type:
        ...
        case PretrainedType.DEFAULT:
            from vocal_forge.rvc.lib.tools.pretrained_selector import (  # noqa: PLC0415
                pretrained_selector,
            )
...
def run_training(
    ...
    upload_model : bool, default=False
        ...
        it can be used for audio generation tasks within the Vocal
        Forge app.
    ...
    from vocal_forge.rvc.train.train import main as train_main  # noqa: PLC0415
    ...
    from vocal_forge.rvc.train.process.extract_index import (  # noqa: PLC0415
